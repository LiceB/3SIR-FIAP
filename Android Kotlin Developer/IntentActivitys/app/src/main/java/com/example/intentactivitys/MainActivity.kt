...
import com.example.intentactivitys.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        databind.imgBtnSmile.setOnClickListener {
    ...
    private fun updateType() {
        when (phraseType) {
            PhraseType.ALL -> {
                ...
                databind.imgBtnSmile.setColorFilter(getColor(R.color.gray))
            }
            PhraseType.SUNNY -> {
            ...
            PhraseType.HAPPY -> {
                databind.imgBtnAll.setColorFilter(getColor(R.color.gray))
                databind.imgBtnSun.setColorFilter(getColor(R.color.gray))
                databind.imgBtnSmile.setColorFilter(getColor(R.color.white))
            }
        }
    }
